...
const (
	exampleConfigFileURL = "https://github.com/root-secure/Amass/blob/master/examples/config.ini"
	userGuideURL         = "https://github.com/root-secure/Amass/blob/master/doc/user_guide.md"
)
